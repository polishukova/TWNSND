export const Camera = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="camera-plus" clip-path="url(#clip0_3732_31461)">
        <path
          id="Vector"
        ...
        />
        <path id="Vector_2" d="M16 19H22" stroke="#032D60" stroke-linecap="round" stroke-linejoin="round" />
        <path id="Vector_3" d="M19 16V22" stroke="#032D60" stroke-linecap="round" stroke-linejoin="round" />
        <path
          id="Vector_4"
